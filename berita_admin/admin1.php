      ...
      <div class="content-wrapper">
        ...
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1 class="m-0">Daftar Berita Masjid</h1>
              </div>
              <!-- /.col -->
              <div class="col-sm-6">
                  ...
                  <div class="card-body table-responsive p-0">
                    <table class="table table-hover text-nowrap">
                      ...
                      <tbody>
                        ...
                        <?php
                          $no=0;
                          $query=mysqli_query($koneksi2,"SELECT * FROM db_siswa1");
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            data-toggle="modal" 
                            data-target="#modal-edit<?php echo $row['id_siswa1'] ?>">Edit</button>
                            <button
                            type="button" 
                            class="btn btn-danger" 
                            data-toggle="modal" 
                            data-target="#modal-hapus<?php echo $row['id_siswa1'] ?>">Hapus</button>
                          </td>
                        </tr>
                        <div class="modal fade" id="modal-hapus<?php echo $row['id_siswa1'] ?>">
                           ...
                           <div class="modal-content">
                             <div class="modal-header">
                              ...
                              <div class="modal-body">
                                <form action="hapus1.php" method="post">
                                  <div class="card-body">
                                    <div class="form-group">
                                      <label for="exampleInputEmail1">Apakah Anda Yakin Mau Menghapus Data Ini</label>
                                      <input type="hidden" name="id_siswa1" value="<?php echo $row['id_siswa1'] ?>">
                                      <input type="text" 
                                      class="form-control" 
                                      name="tanggal" 
                                      placeholder="Enter Data" value="<?php echo $row['tanggal'] ?>" readonly>
                                    </div>
                                  </div>
                        ...
                        <div class="modal fade" id="modal-edit<?php echo $row['id_siswa1'] ?>">
                          <div class="modal-dialog">
                            <div class="modal-content">
                              <div class="modal-header">
                                ...
                                <form action="edit1.php" method="post">
                                  <div class="card-body">
                                    <div class="form-group">
                                      ...
                                      class="form-control" 
                                      name="tanggal" 
                                      placeholder="Enter tanggal" value="<?php echo $row['tanggal'] ?>">
                                    </div>
                                    <div class="form-group">
                                      ...
                                      class="form-control" 
                                      name="judul_berita" 
                                      placeholder="Enter Judul Berita" value="<?php echo $row['judul_berita'] ?>">
                                    </div>
                                    <div class="form-group">
                                      <label for="exampleInputPassword1">Masjid</label>
                                      <input type="text" 
                                      class="form-control" 
                                      name="masjid" 
                                      placeholder="Enter Masjid" value="<?php echo $row['masjid'] ?>">
                                    </div>
                                    <div class="form-group">
                                      ...
                                      class="form-control" 
                                      name="penulis"
                                      placeholder="Enter Penulis" value="<?php echo $row['penulis'] ?>">
                                    </div>
                                    <div class="form-group">
