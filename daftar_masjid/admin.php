                  ...
                  <div class="card-body table-responsive p-0">
                    <table class="table table-hover text-nowrap">
                      ...
                      <tbody>
                        <?php
                          $no=0;
                          $query=mysqli_query($koneksi1,"SELECT * FROM db_siswa");
                        ...
                        <tr>
                          ...
                          <td>
                            <button
                              ...
                              data-toggle="modal"
                              data-target="#modal-edit<?php echo $row['id_siswa'] ?>"
                            >
                              Edit
                            </button>
                            <button
                              ...
                              data-toggle="modal"
                              data-target="#modal-hapus<?php echo $row['id_siswa'] ?>"
                            >
                              Hapus
                            </button>
                          </td>
                        ...
                        <div
                          class="modal fade"
                          id="modal-hapus<?php echo $row['id_siswa'] ?>"
                        >
                                  ...
                                  <div class="card-body">
                                    <div class="form-group">
                                      ...
                                      <input
                                        ...
                                        value="<?php echo $row['nama_masjid'] ?>"
                                        readonly
                                      />
                                    </div>
                                  </div>
                        ...
                        <div
                          class="modal fade"
                          id="modal-edit<?php echo $row['id_siswa'] ?>"
                        >
                          <div class="modal-dialog">
                            <div class="modal-content">
                              <div class="modal-header">
                                  ...
                                  <div class="card-body">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <input
                                        ...
                                        value="<?php echo $row['nama_kecamatan'] ?>"
                                      />
                                    </div>
                                    <div class="form-group">
                                      <label for="exampleInputPassword1"
                                    ...
                                    <div class="form-group">
                                      ...
                                      <input
                                        ...
                                        class="form-control"
                                        name="ketua_dkm"
                                        placeholder="Enter Ketua DKM"
                                        value="<?php echo $row['ketua_dkm'] ?>"
                                      />
                                    </div>
                                    <div class="form-group">
                                      <label for="exampleInputPassword1"
